...
window.OpsLiveMapI18n = {
  de: {
    ...
    statusLine: "{onSite} vor Ort · {cameras} Kameras · {cameraAlerts} Cam-Alarm · {security} Security",
  ...
  en: {
    ...
    statusLine: "{onSite} on-site · {cameras} cameras · {cameraAlerts} cam alerts · {security} security",
