...
window.OpsLiveMapI18n = {
  de: {
    ...
    statusLine: "{onSite} vor Ort · fehlt {missing} · {cameras} Kameras · Cam-Alarm {cameraAlerts} · Security {security}",
    ...
    cameraOk: "Bereit",
    noAutodial: "Kein Auto-Polizei-Anruf",
    clickOpen: "Klick öffnet Chat / Wächter",
    dblClickOpen: "Klick öffnet Chat / Wächter",
    livePosition: "Live-GPS",
    legendWorking: "Arbeitet",
    legendOffSite: "Außerhalb",
    legendStale: "Letzter Standort",
    statusWorking: "Arbeitet",
    statusOffSite: "Außerhalb",
    statusStale: "Letzter Standort",
    statusShiftEnded: "Schicht beendet",
    statusOnBreak: "Pause",
    statusOnTask: "Aufgabe",
    statusLineSmart: "{working} arbeitet · {onBreak} Pause · {onTask} Aufgabe · {offSite} außerhalb · fehlt {missing}",
    zoneStatsTitle: "Zonen-Belegung",
    anomaliesTitle: "Karten-Hinweise",
    nearestTitle: "Nächste Mitarbeiter",
    nearestEmpty: "Keine passenden Mitarbeiter in der Nähe",
    showTrail: "Bewegungsspur",
  ...
  en: {
    ...
    statusLine: "{onSite} on-site · missing {missing} · {cameras} cameras · cam alerts {cameraAlerts} · security {security}",
    ...
    dblClickOpen: "Click opens chat / camera watch",
    livePosition: "Live GPS",
  ...
  ar: {
    ...
    cameraOk: "جاهز",
    noAutodial: "بدون اتصال تلقائي للشرطة",
    clickOpen: "النقر يفتح الدردشة / مراقب الكاميرا",
    dblClickOpen: "النقر يفتح الدردشة / مراقب الكاميرا",
    ...
    statusShiftEnded: "انتهت الوردية",
    ...
    nearestEmpty: "لا توجد عمال متطابقة قريبة",
    showTrail: "عرض المسار",
    trailTitle: "الحركة اليوم",
    trailEmpty: "لا نقاط مسار",
