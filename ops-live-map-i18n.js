...
window.OpsLiveMapI18n = {
  de: {
    ...
    statusLineSmart: "{working} arbeitet · {offSite} außerhalb · {stale} stale · fehlt {missing} · Cam {cameraAlerts}",
  ...
  en: {
    ...
    statusLineSmart: "{working} working · {offSite} off-site · {stale} stale · missing {missing} · cam alerts {cameraAlerts}",
  ...
  ar: {
    ...
    livePosition: "GPS مباشر",
    legendWorking: "يعمل",
    legendOffSite: "خارج الموقع",
    legendStale: "آخر موقع",
    statusWorking: "يعمل",
