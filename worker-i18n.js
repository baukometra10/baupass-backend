...
const TRANSLATIONS = {
  de: {
    ...
    chatVoiceMicDenied: "Mikrofon-Zugriff verweigert. Bitte in den Browser- oder App-Einstellungen erlauben.",
    chatVoiceMicTimeout: "Mikrofon antwortet nicht. Bitte Mikrofon in den Einstellungen erlauben und erneut tippen.",
  ...
  en: {
    ...
    chatVoiceMicDenied: "Microphone access denied. Please allow it in browser or app settings.",
    chatVoiceMicTimeout: "Microphone did not respond. Allow microphone access in settings and try again.",
