...
const TRANSLATIONS = {
  de: {
    ...
    deploymentPlanDraftBanner: "Entwurf: Firma muss Plan noch freigeben, bevor Sie Tage ablehnen können.",
  ...
  en: {
    ...
    deploymentPlanDraftBanner: "Draft: your company must publish the plan before you can decline days.",
