...
const TRANSLATIONS = {
  de: {
    ...
    chatLocationInaccurate: "GPS zu ungenau (±{m} m). Bitte kurz ins Freie gehen — max. {max} m.",
    chatLocationAccuracyApprox: "Standort ungefähr · ±{m} m",
    chatLocationDesktopHint: "Am PC oft WiFi — Handy-App für GPS genau",
  ...
  en: {
    ...
    chatLocationInaccurate: "GPS too imprecise (±{m} m). Step outside briefly — max {max} m.",
    chatLocationAccuracyApprox: "Approximate location · ±{m} m",
    chatLocationDesktopHint: "Desktop often uses WiFi — use mobile app for precise GPS",
