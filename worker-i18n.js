...
const TRANSLATIONS = {
  de: {
    ...
    chatLocationCapturingHint: "Bitte draußen bleiben — Ziel: ±10 m Genauigkeit",
    chatLocationCapturingProgress: "Verfeinern… aktuell ±{m} m (Ziel ≤10 m)",
    chatLocationCancel: "Abbrechen",
    chatLocationInaccurate: "GPS zu ungenau (±{m} m). Bitte ins Freie gehen — max. 10 m nötig.",
  ...
  en: {
    ...
    chatLocationCapturingHint: "Stay outdoors — target ±10 m accuracy",
    chatLocationCapturingProgress: "Refining… currently ±{m} m (target ≤10 m)",
    chatLocationCancel: "Cancel",
    chatLocationInaccurate: "GPS too imprecise (±{m} m). Move outdoors — max 10 m required.",
