...
const TRANSLATIONS = {
  de: {
    ...
    chatLocationInaccurate: "GPS zu ungenau (±{m} m). Internet ≠ GPS — Worker-App am Handy oder kurz ins Freie. Max. {max} m.",
    chatLocationAccuracyApprox: "Standort ungefähr · ±{m} m",
    chatLocationDesktopHint: "WiFi am PC oft daneben — Handy-App für genauen Standort",
  ...
  en: {
    ...
    chatLocationInaccurate: "GPS too imprecise (±{m} m). Internet ≠ GPS — use mobile app or step outside. Max {max} m.",
    chatLocationAccuracyApprox: "Approximate location · ±{m} m",
    chatLocationDesktopHint: "Desktop WiFi location is often wrong — use the mobile worker app",
