...
const TRANSLATIONS = {
  de: {
    ...
    docTypeVerdienstbescheinigung: "Verdienstbescheinigung",
    ...
    workerChatAdminMessageTitle: "Neue Nachricht vom Arbeitgeber",
    ...
    voiceCallCameraOff: "Kamera aus",
    voiceCallCameraRequesting: "Kamera-Anfrage wird gesendet…",
    voiceCallFlipCamera: "Kamera wechseln",
    voiceCallVideoCall: "Videoanruf",
    voiceCallVideoConnecting: "Video verbindet…",
    voiceCallVideoQualityHd: "Video: 720p",
    voiceCallVideoQualitySd: "Video: 480p (Netz)",
    voiceCallCamPreviewHint: "Kamera-Vorschau — noch nicht gesendet",
    voiceCallCamPreviewConfirm: "Freigeben",
    voiceCallCamPreviewCancel: "Abbrechen",
    voiceCallCameraDenied: "Kamerazugriff verweigert",
    voiceCallCameraMissing: "Keine Kamera gefunden",
    voiceCallCameraBusy: "Kamera ist belegt",
    voiceCallCameraFailed: "Kamera konnte nicht aktiviert werden",
    voiceCallBlur: "Blur",
    voiceCallScreenShare: "Bildschirm",
    voiceCallRecord: "Aufnahme",
    voiceCallShareImage: "Bild",
    voiceCallImageSent: "Bild gesendet",
    voiceCallImageFailed: "Bild konnte nicht gesendet werden.",
    voiceCallControlsWait: "Anruf noch nicht verbunden — kurz warten.",
    voiceCallPeerCameraIntent: "{name} möchte die Kamera öffnen.",
    voiceCallPeerCameraOn: "{name} hat die Kamera eingeschaltet.",
    voiceCallImageFrom: "Bild von {name}",
  ...
  en: {
    ...
    workerChatAdminMessageTitle: "New message from employer",
    ...
    docTypeVerdienstbescheinigung: "Earnings certificate",
    ...
    voiceCallCameraOff: "Camera off",
    voiceCallCameraRequesting: "Sending camera request…",
    voiceCallFlipCamera: "Flip camera",
    voiceCallVideoCall: "Video call",
    voiceCallVideoConnecting: "Connecting video…",
    voiceCallVideoQualityHd: "Video: 720p",
    voiceCallVideoQualitySd: "Video: 480p (network)",
    voiceCallCamPreviewHint: "Camera preview — not sent yet",
    voiceCallCamPreviewConfirm: "Share",
    voiceCallCamPreviewCancel: "Cancel",
    voiceCallCameraDenied: "Camera permission denied",
    voiceCallCameraMissing: "No camera found",
    voiceCallCameraBusy: "Camera is in use",
    voiceCallCameraFailed: "Could not enable camera",
    voiceCallBlur: "Blur",
    voiceCallScreenShare: "Screen",
    voiceCallRecord: "Record",
    voiceCallShareImage: "Photo",
    voiceCallImageSent: "Photo sent",
    voiceCallImageFailed: "Could not send photo.",
    voiceCallControlsWait: "Call not connected yet — please wait.",
    voiceCallPeerCameraIntent: "{name} wants to open the camera.",
    voiceCallPeerCameraOn: "{name} turned the camera on.",
    voiceCallImageFrom: "Photo from {name}",
  ...
  ar: {
    ...
    docTypeVerdienstabrechnung: "شهادة الدخل",
    docTypeVerdienstbescheinigung: "شهادة الدخل",
    ...
    voiceCallCamera: "الكاميرا",
    voiceCallCameraOff: "إيقاف الكاميرا",
    voiceCallCameraRequesting: "جاري إرسال طلب الكاميرا…",
    voiceCallFlipCamera: "تبديل الكاميرا",
    voiceCallVideoCall: "مكالمة فيديو",
    voiceCallVideoConnecting: "جاري اتصال الفيديو…",
    voiceCallVideoQualityHd: "فيديو: 720p",
    voiceCallVideoQualitySd: "فيديو: 480p (الشبكة)",
    voiceCallCamPreviewHint: "معاينة الكاميرا — لم تُرسل بعد",
    voiceCallCamPreviewConfirm: "مشاركة",
    voiceCallCamPreviewCancel: "إلغاء",
    voiceCallCameraDenied: "تم رفض إذن الكاميرا",
    voiceCallCameraMissing: "لا توجد كاميرا",
    voiceCallCameraBusy: "الكاميرا قيد الاستخدام",
    voiceCallCameraFailed: "تعذر تفعيل الكاميرا",
    voiceCallBlur: "تمويه",
    voiceCallScreenShare: "الشاشة",
    voiceCallRecord: "تسجيل",
    voiceCallShareImage: "صورة",
    voiceCallImageSent: "تم إرسال الصورة",
    voiceCallImageFailed: "تعذر إرسال الصورة.",
    voiceCallControlsWait: "المكالمة غير متصلة بعد — انتظر قليلاً.",
    voiceCallPeerCameraIntent: "{name} يريد فتح الكاميرا.",
    voiceCallPeerCameraOn: "{name} فعّل الكاميرا.",
    voiceCallImageFrom: "صورة من {name}",
