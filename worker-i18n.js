...
const TRANSLATIONS = {
  de: {
    ...
    geolocationRequired: "Bitte Standortfreigabe aktivieren und direkt am Standort anmelden.",
  ...
  en: {
    ...
    geolocationRequired: "Please enable location access and sign in at the site.",
