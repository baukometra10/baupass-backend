...
- [x] Live-Smoke (automatisiert): GPS=3, mark-read Routes, Invoice sandbox, Stripe allowlist, Berlin calendar — pytest 2026-07-20
- [ ] Live: 3× Off-Site → Checkout; Chat quiet-poll behält Unread (manuell / Gerät vor Ort)
