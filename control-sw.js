const SHELL_CACHE = "baupass-control-shell-v51";
const RUNTIME_CACHE = "baupass-control-runtime-v51";
const SHELL_ASSETS = [
  "/",
  "/index.html",
  "/index.html?v=20260507a",
  "/app.js",
  "/app.js?v=20260507a",
  "/styles.css",
  ...
  if (isNavigation) {
    event.respondWith(
      networkFirst(request).catch(async () => (
        ...
        (await caches.match("/index.html?v=20260418f")) ||
