const SHELL_CACHE = "baupass-control-shell-v71";
const RUNTIME_CACHE = "baupass-control-runtime-v71";
const SHELL_ASSETS = [
  "/",
  "/index.html",
  "/index.html?v=20260524f",
  "/app.js",
  "/app.js?v=20260524f",
  "/styles.css",
  "/styles.css?v=20260524f",
  "/desktop/renderer.js",
  "/desktop/renderer.js?v=20260524f",
