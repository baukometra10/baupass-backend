const SHELL_CACHE = "baupass-control-shell-v66";
const RUNTIME_CACHE = "baupass-control-runtime-v66";
const SHELL_ASSETS = [
  "/",
  "/index.html",
  "/index.html?v=20260510aa",
  "/app.js",
  "/app.js?v=20260510aa",
  "/styles.css",
  "/styles.css?v=20260510aa",
  ...
  if (isNavigation) {
    event.respondWith(
      networkFirst(request).catch(async () => (
        ...
        (await caches.match("/index.html?v=20260510aa")) ||
