...
const STATIC_ASSETS = [
  ...
  { path: "/worker-icon-192-20260511e.png" },
  { path: "/worker-icon-512-20260511e.png" },
  { path: "/worker-icon-192-20260511e.svg" },
  { path: "/worker-icon-512-20260511e.svg" }
];
