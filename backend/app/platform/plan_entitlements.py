...
PLAN_META: dict[str, dict[str, Any]] = {
    "tageskarte": {
        ...
        "labelAr": "بطاقة يومية",
        "priceEur": 19,
        "taglineDe": "Basis-Anwesenheit und Zutritt",
        "taglineEn": "Basic attendance and site access",
        "taglineAr": "حضور ودخول أساسي للموقع",
    },
    "starter": {
        "label": "Starter",
        "labelAr": "مبتدئ",
        "priceEur": 149,
        "taglineDe": "Worker-App + NFC + Urlaub",
        "taglineEn": "Worker app + NFC + leave",
        "taglineAr": "تطبيق الموظف + NFC + إجازات",
    },
    "professional": {
        "label": "Professional",
        "labelAr": "احترافي",
        "priceEur": 999,
        "taglineDe": "Echtzeit-Betrieb + Automatisierung + Reporting",
        "taglineEn": "Real-time ops + automation + reporting",
        "taglineAr": "تشغيل لحظي + أتمتة + تقارير + فوترة",
    },
    "enterprise": {
        "label": "Enterprise",
        "labelAr": "مؤسسي",
        "priceEur": 2490,
        "taglineDe": "KI + Integrationen + globales Command Center",
        "taglineEn": "AI + integrations + global command center",
        "taglineAr": "AI + تكاملات + قيادة عالمية + أمان متقدم",
    },
}
