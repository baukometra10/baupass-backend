...
FAB_SCRIPT_VERSION = os.getenv("BAUPASS_AI_OPERATOR_FAB_VERSION", "20260818fab15").strip() or "20260818fab15"
VOICE_UI_VERSION = os.getenv("BAUPASS_AI_VOICE_UI_VERSION", "20260818voice14").strip() or "20260818voice14"
